...
public class Compress {
     ...
     * 压缩，native方法
     */
    public native static String compressBitmap(Bitmap bitmap, int quality, byte[] filenameBytes, boolean optimize);
     ...
     */
    public static String compressBitmap(Bitmap image, String filePath, int maxSize, int quality) {
        // 获取尺寸压缩倍数
        ...
        // JNI保存图片到SD卡 这个关键
        String resultStr = compressBitmap(result, options, filePath.getBytes(), true);
        // 释放Bitmap
     ...
     */
    public static String compressBitmap(String curFilePath, String targetFilePath, int maxSize, int quality) {
        //根据地址获取bitmap
        ...
        // JNI保存图片到SD卡 这个关键
        String resultStr = compressBitmap(result, options, targetFilePath.getBytes(), true);
        // 释放Bitmap
        if (!result.isRecycled()) {
            result.recycle();
        }
